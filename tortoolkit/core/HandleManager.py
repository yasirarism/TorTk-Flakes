...
async def handle_leech_command(e):
    ...
    if not e.is_reply:
        await e.reply("⚠ <u>Reply to a direct link, yt link, ig link, .torrent file, or magnet link</u>\n\n<b>🔰 SUPPORT DIRECT LINK GENERATOR:</b> -Auto downloading file only for Host <code>Mediafire.com link</code> and <code>Zippyshare.com link</code>")
    else:
        rclone = False
        tsp = time.time()
